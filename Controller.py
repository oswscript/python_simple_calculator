  ...
  #data capture process
	def process_main(self,init= True):
		...
		if self.type_operation > 0 and self.type_operation <= 4:#if the selection is between 1 and 4
				...
				self.num1 = int(raw_input("Input value 1: "))#Input first number
				self.num2 = int(raw_input("Input value 2: "))#Input second number
				print "\n********** The result is: " + str(self.operate()) + " ********** \n"#show result of the operation	
